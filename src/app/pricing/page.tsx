...
export const metadata: Metadata = {
  title: "Pricing — Ap World History Modern Premium",
  description: "Unlock unlimited Ap World History Modern practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ap-world-history-modern&cadence=annual`;
